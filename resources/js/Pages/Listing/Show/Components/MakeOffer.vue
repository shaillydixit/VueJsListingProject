...
const makeOffer = () => {
  form.post(
    route('realtor.listing.offer.store', { listing: props.listingId }), // Correct the route name and pass the listing ID
    {
      preserveScroll: true,
      preserveState: true,
      onSuccess: () => {
        // Optional: Add any success handling here, if necessary
      },
      onError: (errors) => {
